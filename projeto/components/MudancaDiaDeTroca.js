...
class MudancaDiaDeTroca extends React.Component{
  ...
  render(){
    ...
    <View style={estilos.container}>
      ...
      <Spacer size={20} />
      <TextInput style={estilos.caixaTroca} onChangeText={(texto)=>this.setState({dia: texto})}></TextInput>
      <Spacer size={20} />
  ...
  async atualizacao(){
    try{
      const valueDay = await AsyncStorage.mergeItem("dia", JSON.parse(value));
